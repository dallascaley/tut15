...
app.listen(process.env.PORT || 3000, () => {
  // Note, the comment below was misleading so i fixed it.
  let actualPort = process.env.PORT || 3000;
  console.log(`Server started (http://localhost:${actualPort}/) !`);
});
...
// Seed the books table with some data
